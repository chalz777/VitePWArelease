    ...
    return {
        ...
        transformIndexHtml: {
            ...
            async transform(html) {
                ...
                return html.replace('</body>', `${generateRegisterDevSW()}
</body>`);
            },
        },
            ...
            if (!options.disable && options.devOptions.enabled) {
                ...
                if (id.endsWith(swDevOptions.swUrl)) {
                    ...
                    if (!swDevOptions.swDevGenerated || !existsSync(swDest)) {
                        ...
                        const { filePaths } = await generateServiceWorker(Object.assign({}, options, {
                            swDest: options.selfDestroying ? swDest : options.swDest,
                            workbox: Object.assign(Object.assign({}, options.workbox), { navigateFallbackAllowlist: (_a = options.devOptions.navigateFallbackAllowlist) !== null && _a !== void 0 ? _a : [/^\/$/], runtimeCaching: options.devOptions.disableRuntimeConfig ? undefined : options.workbox.runtimeCaching, 
