...
async function loadWorkboxBuild() {
    ...
    try {
        ...
        return (_a = workbox.default) !== null && _a !== void 0 ? _a : workbox;
    }
    catch (_) {
...
export async function generateRegisterSW(options, mode, source = 'register') {
...
export async function generateServiceWorker(options, viteOptions) {
...
export async function generateInjectManifest(options, viteOptions) {
    ...
    */
    ...
    const injectManifestOptions = Object.assign(Object.assign({}, options.injectManifest), { 
