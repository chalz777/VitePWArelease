                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            _d = ctx;
                            return [4 /*yield*/, resolveOptions(ctx.userOptions, config)];
                        case 1:
                            _d.options = _e.sent();
                            return [2 /*return*/];
                    }
        ...
        load: function (id) {
            ...
            if (VIRTUAL_MODULES.includes(id)) {
                ...
                if (ctx.viteConfig.command === 'serve' && ctx.options.devOptions.enabled) {
                    return generateRegisterSW(__assign(__assign({}, ctx.options), { filename: swDevOptions.swUrl }), 'build', VIRTUAL_MODULES_MAP[id]);
                }
                else {
