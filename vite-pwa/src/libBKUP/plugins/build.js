    ...
    return {
        ...
        transformIndexHtml: {
            ...
            transform: function (html) {
                var options = ctx.options, useImportRegister = ctx.useImportRegister;
                if (options.disable)
                    return html;
        ...
        generateBundle: function (ctx, bundle) {
            ...
            handler: function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(!ctx.viteConfig.build.ssr && !ctx.options.disable)) return [3 /*break*/, 2];
                                return [4 /*yield*/, _generateSW(ctx)];
                            case 1:
                                _a.sent();
                                _a.label = 2;
