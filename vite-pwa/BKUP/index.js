...
var require_is_glob = __commonJS({
  "node_modules/is-glob/index.js"(exports, module) {
    ...
    module.exports = function isGlob(str, options2) {
      if (typeof str !== "string" || str === "") {
        return false;
      }
      if (isExtglob(str)) {
...
var require_fill_range = __commonJS({
  "node_modules/fill-range/index.js"(exports, module) {
    ...
    var toRange = (a, b, isNumbers, options2) => {
      if (isNumbers) {
        return toRegexRange(a, b, __spreadValues({ wrap: false }, options2));
      }
      ...
      const extglobClose = (token) => {
        ...
        if (token.type === "negate") {
          ...
          if (token.inner.includes("*") && (rest = remaining()) && /^\.[^\\/.]+$/.test(rest)) {
            const expression = parse(rest, __spreadProps(__spreadValues({}, options2), { fastpaths: false })).output;
...
var require_picomatch = __commonJS({
  "node_modules/picomatch/lib/picomatch.js"(exports, module) {
    ...
    var picomatch = (glob, options2, returnState = false) => {
      ...
      let isIgnored = () => false;
      if (opts.ignore) {
        const ignoreOpts = __spreadProps(__spreadValues({}, options2), { ignore: null, onMatch: null, onResult: null });
    ...
    picomatch.parse = (pattern, options2) => {
      ...
      return parse(pattern, __spreadProps(__spreadValues({}, options2), { fastpaths: false }));
    };
  ...
  "node_modules/micromatch/index.js"(exports, module) {
    ...
    var micromatch = (list, patterns, options2) => {
      ...
      for (let i = 0; i < patterns.length; i++) {
        let isMatch = picomatch(String(patterns[i]), __spreadProps(__spreadValues({}, options2), { onResult }), true);
    ...
    micromatch.not = (list, patterns, options2 = {}) => {
      ...
      let matches = new Set(micromatch(list, patterns, __spreadProps(__spreadValues({}, options2), { onResult })));
    ...
    micromatch.contains = (str, pattern, options2) => {
      ...
      return micromatch.isMatch(str, pattern, __spreadProps(__spreadValues({}, options2), { contains: true }));
    };
    ...
    micromatch.capture = (glob, input, options2) => {
      ...
      let regex = picomatch.makeRe(String(glob), __spreadProps(__spreadValues({}, options2), { capture: true }));
    ...
    micromatch.braceExpand = (pattern, options2) => {
      if (typeof pattern !== "string")
        throw new TypeError("Expected a string");
      return micromatch.braces(pattern, __spreadProps(__spreadValues({}, options2), { expand: true }));
    };
...
function generateSimpleSWRegister(options2, dev) {
  ...
  if (dev) {
    const swType = (_a = options2.devOptions.type) != null ? _a : "classic";
...
function generateWebManifest(options2, dev) {
  ...
  if (dev) {
    const name = (_a = options2.devOptions.webManifestUrl) != null ? _a : `${options2.base}${options2.manifestFilename}`;
...
// src/lib/modules.ts
var import_meta = {};
var _dirname = typeof __dirname !== "undefined" ? __dirname : dirname(fileURLToPath(import_meta.url));
async function loadWorkboxBuild() {
  var _a;
  try {
    const workbox = await import("workbox-build");
    return (_a = workbox.default) != null ? _a : workbox;
  } catch (_) {
...
async function generateInjectManifest(options2, viteOptions) {
  ...
  try {
    console.log("module:swDest " + options2.injectManifest.swDest);
    await bundle.write({
  ...
  return {
    ...
    webManifestData() {
      ...
      if (ctx.devEnvironment && ctx.options.devOptions.enabled === true) {
        url = (_a = ctx.options.devOptions.webManifestUrl) != null ? _a : options2.manifestFilename;
    ...
    registerSWData() {
      ...
      if (ctx.devEnvironment && ctx.options.devOptions.enabled === true) {
        type = (_a = ctx.options.devOptions.type) != null ? _a : "classic";
...
function BuildPlugin(ctx) {
  ...
  return {
    ...
    generateBundle(ctx2, bundle) {
      return _generateBundle(ctx2, bundle);
    },
    closeBundle: {
      sequential: true,
              ...
              Object.assign(
                ...
                options2,
                {
                  ...
                  workbox: __spreadProps(__spreadValues({}, options2.workbox), {
                    navigateFallbackAllowlist: (_a = options2.devOptions.navigateFallbackAllowlist) != null ? _a : [/^\/$/],
...
async function resolveOptions(options2, viteConfig) {
  ...
  const _a = options2.injectManifest || {}, {
    vitePlugins = defaultInjectManifestVitePlugins,
    rollupFormat = "es"
  } = _a, userInjectManifest = __objRest(_a, [
    "vitePlugins",
    "rollupFormat"
  ]);
      ...
      if (VIRTUAL_MODULES.includes(id)) {
        ...
        if (ctx.viteConfig.command === "serve" && ctx.options.devOptions.enabled) {
          return generateRegisterSW2(
            __spreadProps(__spreadValues({}, ctx.options), { filename: swDevOptions.swUrl }),
            "build",
